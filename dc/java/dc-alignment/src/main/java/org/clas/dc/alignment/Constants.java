...
//                                           0.1,    0.8,    0.2,     0.2,     0.1,     0.4};
    ...
    // target parameters
    public static double TARGETPOS    = -1.5;
    public static double TARGETLENGTH =  5;    //target length
    public static double WINDOWDIST   =  8.5;  //6.8;//2.8; //distance between the mylar foil and the downstream window
    public static double SCEXIT       = 14.3;  //scattering chamber exit window, old value from PDF - 2 mm for the window bow
